    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProducts", x => new { x.SubCategoryId, x.ProductId });
                    table.UniqueConstraint("AK_CategoryProducts_Id", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_ShopUserId",
            ...
            migrationBuilder.CreateTable(
                name: "ShopUserFavoriteProducts",
                columns: table => new
                {
                    ShopUserId = table.Column<string>(nullable: false),
                    ProductId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopUserFavoriteProducts", x => new { x.ShopUserId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ShopUserFavoriteProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopUserFavoriteProducts_AspNetUsers_ShopUserId",
                        column: x => x.ShopUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopUserFavoriteProducts_ProductId",
                table: "ShopUserFavoriteProducts",
                column: "ProductId");
